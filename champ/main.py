...
Usage:
  ...
  champ init IMAGE_DIRECTORY READ_NAMES_DIRECTORY [ALIGNMENT_CHANNEL] [--perfect-target-name=PERFECT_TARGET_NAME] [--neg-control-target-name=NEG_CONTROL_TARGET_NAME] [--alternate-perfect-reads=ALTERNATE_PERFECT_READS] [--alternate-good-reads=ALTERNATE_GOOD_READS] [--alternate-fiducial-reads=ALTERNATE_FIDUCIAL_READS] [--microns-per-pixel=0.266666666] [--chip=miseq] [--ports-on-right] [--flipud] [--fliplr] [--override-meta] [-v | -vv | -vvv ]
  champ h5 IMAGE_DIRECTORY [--min-column=MINCOL] [--max-column=MAXCOL] [--subdivision-size=SUBSIZE] [--override-meta] [-v | -vv | -vvv]
